"""
Django settings for decoaires_be project.
...
SECRET_KEY = 'p(++*59c3^)m*+waz&@+)=d1)+gr*tst&gb(+w4am00n+#o=ij'
...
ROOT_URLCONF = 'decoaires_be.urls'
...
WSGI_APPLICATION = 'decoaires_be.wsgi.application'
